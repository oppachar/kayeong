...
lip_w = (list_points[MOUTH_OUTLINE][0]-list_points[MOUTH_OUTLINE][6])[0] #입술 가로
lip_h = (list_points[MOUTH_OUTLINE][4]-list_points[MOUTH_OUTLINE][8])[1] #입술 세로

print(lip_w,lip_h)
print("입 면적 : ", lip_w*lip_h)

nose_w = (list_points[NOSE][4]-list_points[NOSE][8])[0] #코 가로
nose_h = (list_points[NOSE][0]-list_points[NOSE][6])[1] #코 세로

print(nose_w,nose_h)
print("코 면적 : ", nose_w*nose_h)

leye_w = (list_points[LEFT_EYE][0]-list_points[LEFT_EYE][3])[0] #왼쪽 눈 가로
leye_h = (list_points[LEFT_EYE][1]-list_points[LEFT_EYE][5])[1] #왼쪽 눈 세로

print(leye_w,leye_h)
print("왼쪽 눈 면적 : ", leye_w*leye_h)

reye_w = (list_points[RIGHT_EYE][0]-list_points[RIGHT_EYE][3])[0] #오른쪽 눈 가로
reye_h = (list_points[RIGHT_EYE][1]-list_points[RIGHT_EYE][5])[1] #오른쪽 눈 세로
