...
from FaceMeshBasics import newnose
#from FaceMeshBasics import newnose_w
...
if (abs(list_points[RIGHT_EYE][3][0] - newnose[0][0]) <= 5):
    print("콧볼 크기 평균")
elif (newnose[0][0] - list_points[RIGHT_EYE][3][0] > -5):
    print("콧볼 크기 %.1f%% 큰 편" %(abs(newnose[0][0] - list_points[RIGHT_EYE][3][0])/face_w)    )
elif (newnose[0][0] - list_points[RIGHT_EYE][3][0] > 5):
    print("콧볼 크기 %.1f%% 작은 편" %(abs(newnose[0][0] - list_points[RIGHT_EYE][3][0])/face_w))
